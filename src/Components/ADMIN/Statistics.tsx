      ...
      <ol className='relative border-l border-gray-200'>
        <li className='mb-10 ml-4'>
          ...
          <a href='/' className='inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-primary-700 '>
            Learn more
            {' '}
            <svg className='w-3 h-3 ml-2' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z' clip-rule='evenodd' /></svg>
          </a>
        </li>
        <li className='mb-10 ml-4'>
          <div className='absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white' />
          ...
          <div className='duration-700 ease-in-out bg-white' data-carousel-item>
            ...
            <a href='/' className='inline-flex items-center p-2 font-medium rounded-lg text-primary-700 hover:bg-gray-100'>
              ...
              <svg className='w-5 h-5 ml-1' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' aria-hidden='true'>
                <path clip-rule='evenodd' fill-rule='evenodd' d='M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z' />
              </svg>
            </a>
          </div>
          <div className='duration-700 ease-in-out bg-white' data-carousel-item>
            <div className='flex items-center mb-4 text-lg font-medium text-teal-500'>
              <svg className='w-6 h-6 mr-2' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' aria-hidden='true'>
                <path clip-rule='evenodd' fill-rule='evenodd' d='M4.606 12.97a.75.75 0 01-.134 1.051 2.494 2.494 0 00-.93 2.437 2.494 2.494 0 002.437-.93.75.75 0 111.186.918 3.995 3.995 0 01-4.482 1.332.75.75 0 01-.461-.461 3.994 3.994 0 011.332-4.482.75.75 0 011.052.134z' />
                <path clip-rule='evenodd' fill-rule='evenodd' d='M5.752 12A13.07 13.07 0 008 14.248v4.002c0 .414.336.75.75.75a5 5 0 004.797-6.414 12.984 12.984 0 005.45-10.848.75.75 0 00-.735-.735 12.984 12.984 0 00-10.849 5.45A5 5 0 001 11.25c.001.414.337.75.751.75h4.002zM13 9a2 2 0 100-4 2 2 0 000 4z' />
              </svg>
              Tips to grow
            </div>
          ...
          <div className='duration-700 ease-in-out bg-white' data-carousel-item>
            ...
            <ul className='pl-2 my-5 mb-4 space-y-3 text-gray-500 list-disc'>
              <li className='flex space-x-3'>
                {/* <!-- Icon --> */}
                <svg className='flex-shrink-0 w-5 h-5 text-purple-600' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z' clip-rule='evenodd' /></svg>
                <span className='leading-tight'>Dynamic reports and dashboards</span>
              </li>
              <li className='flex space-x-3'>
                {/* <!-- Icon --> */}
        ...
        <div className='flex items-center justify-center'>
          <button type='button' className='flex items-center justify-center h-full mr-4 cursor-pointer group focus:outline-none' data-carousel-prev>
            <span className='text-gray-500 dark:text-gray-400 hover:text-gray-700'>
              <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M7.707 14.707a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l2.293 2.293a1 1 0 010 1.414z' clip-rule='evenodd' /></svg>
          ...
          <button type='button' className='flex items-center justify-center h-full cursor-pointer group focus:outline-none' data-carousel-next>
            <span className='text-gray-500 hover:text-gray-700 '>
              <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'><path fill-rule='evenodd' d='M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z' clip-rule='evenodd' /></svg>
