        ...
        <div className='flex flex-col flex-1 pt-5 pb-4 overflow-y-auto'>
          <div className='flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200'>
            <ul className='pb-2 space-y-2'>
              ...
              <li>
                <Link to='/admin' className='flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700'>
                  <svg className='flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg' aria-hidden='true'>
            ...
            <div className='pt-2 space-y-2'>
              <a href='https://github.com/themesberg/flowbite-admin-dashboard' target='_blank' className='flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700' rel='noreferrer'>
              ...
              <a href='https://flowbite.com/docs/components/alerts/' target='_blank' className='flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700' rel='noreferrer'>
              ...
              <a href='https://github.com/themesberg/flowbite-admin-dashboard/issues' target='_blank' className='flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700' rel='noreferrer'>
