                    ...
                    <div className='mt-2 w-full'>
                      <div className='grid grid-cols-2 gap-x-10 gap-y-6 mb-6 w-full'>
                        ...
                        <div>
                          ...
                          <select value={register.role} onChange={(e) => setRegister({ ...register, role: e.target.value })} required id='gender' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 '>
