...
const Fir = (): JSX.Element => {
  ...
  const policeStation = ['Arey', 'AgriPada', 'Airport', 'Amboli', 'Andheri', 'Antop Hill', 'Azad Maidan', 'BKC', 'Bandra']

  const [fir, setFir] = useState<FirModel>({
    name: '',
    phone: undefined,
    email: '',
    address1: ''
    ...
    <div>
      ...
      <main className="fir">
        ...
        <div className="disclaimer mb-5">
          ...
          <p>
            This site shall only entertain complaints about minor crimes (′non-cognizable crimes′).Your complaint shall be
            referred to the concerned Police Station, where you may be called for further clarification and/or to give
            statement.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="row">
              ...
              <div className="col-md p-float-label mr-3">
                <InputMask
                  ...
                  required
                  value={fir.phone}
                  onChange={(e: InputMaskChangeEvent) => { setFir({ ...fir, [e.target.name]: e.target.value }) }}
                  id="phone"
                  mask="99999-99999"
                />
          ...
          <div className="container2 my-8">
            <div className="row">
              <div className="col-md p-float-label mr-3">
                ...
                <label htmlFor="add1" className="ml-3">
                  Room No. / Street Name
                </label>
              </div>
              <div className="col-md p-float-label mr-3">
                <InputText id="add2" placeholder="Eg: Sector1, Bandra, Mumbai" />
                <label htmlFor="add2" className="ml-3">
                  Address
                </label>
              </div>
              <div className="col-md p-float-label mr-3">
          ...
          <div className="container3 my-8">
            <div className="row">
              <div className="col-md p-float-label mr-3">
                ...
                <label className="ml-3" htmlFor="dropdown">
                  Select State
                </label>
              </div>
              <div className="col-md p-float-label mr-3">
                <InputText id="add3" placeholder="India" />
                <label htmlFor="add3" className="ml-3">
                  Country
                </label>
              </div>
            </div>
          ...
          <div className="container4 my-8">
            <div className="row">
              <div className="col-md p-float-label mr-3">
                ...
                <label htmlFor="pincode" className="ml-3">
                  Pin Code
                </label>
              </div>
              <div className="col-md p-float-label mr-3">
          ...
          <div className="container7 my-8 d-flex">
            ...
            <label htmlFor="policy" className="ml-2">
              ...
              knowledge. I understand that withholding of information or giving false information is a criminal offense and
              may result in legal action against me.
            </label>
          </div>
