        ...
        <div className='p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 w-full'>
          <div className='w-full mb-1'>
            <div className='mb-4'>
                ...
                <ol className='inline-flex items-center space-x-1 text-sm font-medium md:space-x-2'>
                  ...
                  <li>
                    <div className='flex items-center'>
                      ...
                      <a href='/' className='ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white'>Police Stations</a>
                    </div>
                  </li>
                  <li>
                    <div className='flex items-center'>
              ...
              <h1 className='text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white'>All Police Station Under Your Authority</h1>
            </div>
              ...
              <div className='items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700'>
                <form className='lg:pr-3' action='#' method='GET'>
                  ...
                  <div className='relative mt-1 lg:w-64 xl:w-96'>
                    <input type='text' name='email' id='station-search' className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' placeholder='Search for police stations' />
                  </div>
                </form>
              </div>
                      ...
                      <tr className='hover:bg-gray-100 dark:hover:bg-gray-700'>
                        ...
                        <td className='flex items-center p-4 mr-12 space-x-6 whitespace-nowrap'>
                          <div className='text-sm font-normal text-gray-500 dark:text-gray-400'>
                            ...
                            <div className='text-sm font-normal text-gray-500 dark:text-gray-400'>{p.area}</div>
                          </div>
                        </td>
                        <td className='max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400'>{p.address}</td>
                        <td className='p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white'>{p.pincode}</td>
                        <td className='p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white'>{p.area}</td>
