      ...
      <main className="home">
        ...
        <div className="hero">
          <div className="hero__left">
            ...
            <p className="hero__description mt-4">Welcome to Police Station! Taking stock of your security round the clock! Dial 100 in case of any emergency. Help us to help you.</p>
          </div>
        ...
        <div className="cards">
          <div className="card">
            <div className="card-body">
              ...
              <NavLink to="/status" className="card-link">Click Here</NavLink>
            </div>
          </div>
          <div className="card">
            <div className="card-body">
              ...
              <NavLink to="#" className="card-link">Click Here</NavLink>
            </div>
          </div>
          <div className="card">
            <div className="card-body">
